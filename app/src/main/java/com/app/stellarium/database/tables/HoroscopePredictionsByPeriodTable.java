...
public class HoroscopePredictionsByPeriodTable {
    ...
    public final static String COLUMN_PERIOD_SIGN = "PERIOD_SIGN";
    public final static String COLUMN_CHARACTERISTIC_ID = "CHARACTERISTIC_ID";
    ...
    public final static String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME + "("
            + COLUMN_ID + " INTEGER PRIMARY KEY," + COLUMN_SIGN_NAME + " TEXT NOT NULL,"
            + COLUMN_PERIOD_SIGN + " TEXT NOT NULL," + COLUMN_CHARACTERISTIC_ID + " INTEGER NOT NULL,"
